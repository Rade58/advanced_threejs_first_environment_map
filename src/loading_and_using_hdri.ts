...
// LOADING AND USING HDRI

// I also pasted a 2k hdr files in our textures
// for environment maps

// we are going to use hdr file instead 6 of images we used

// HDR (High Dynamic Range)
// We often say `HDRI` where i stands for "image"
// Color values stored have a much higher range than a traditional image
// (ideal store luminosity data)

// comment old environmentMap
// keep backgroundBlurriness and backgroundIntensity
// we played with in previous lesson

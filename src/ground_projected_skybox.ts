...
// our environment map is always the samee size no matter how we move camera
// we want to add dept

// We want to as we move camera to have effect that we are getting near or far
// from the scenary of the environment map

// and we want mentioned effect to be visiblee in relation to object we added

import { GroundedSkybox } from "three/examples/jsm/Addons.js";
//
// we use this after we load hdri
//

// I wasn't able to acomplish the wanted effect in this case
// since API changed
...
const parameters = {
  ...
  "envMapIntensity for material of torusKnot": 1,
...
if (canvas) {
   ...
   */
  rgbeLoader.load(
    "/textures/environmentMaps/field/2k.hdr",
    (environmentMap) => {
